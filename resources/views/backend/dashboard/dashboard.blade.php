                    ...
                    <ul class="nav nav-tabs" style="background: #2b8d06;" id="myTab" role="tablist">
                        ...
                        <li class="nav-item text-center" style="width:33%;">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                               aria-controls="profile" aria-selected="false">Sản phẩm bán chạy</a>
                        </li>
                        <li class="nav-item text-center" style="width:33%;">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                               aria-controls="contact" aria-selected="false">Sản phẩm yêu thích</a>
                        </li>
                    </ul>
                                        ...
                                        @if ($dataTagNav[0] != null)
                                            ...
                                            @foreach ($dataTagNav[0] as $product)
                                                <tr>
                                                    ...
                                                    <td><img style="width: 50px" src="{{$product->product_image}}"
                                                             alt=""></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                            ...
                                            @foreach ($dataTagNav[1] as $product)
                                                <tr>
                                                    ...
                                                    <td><img style="width: 50px"
                                                             src="{{$product->product->product_image}}" alt=""></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        @endif
