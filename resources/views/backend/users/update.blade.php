          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select name="role_id" class="form-control">
                      <option value="1" @if ($data->role_id == 1) {{"selected"}} @endif>Admin</option>
                      <option value="2" @if ($data->role_id == 2) {{"selected"}} @endif>Quản lý sản phẩm</option>
                      <option value="3" @if ($data->role_id == 3) {{"selected"}} @endif>Người dùng</option>
                    </select>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="bmd-label-floating">Mật khẩu mới (để trống nếu không muốn thay đổi)</label>
            ...
            <button type="submit" class="btn btn-primary pull-right">Sửa Tài Khoản</button>
