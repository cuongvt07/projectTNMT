                    ...
                    if (Array.isArray(data[0])) {
                        ...
                        data[0].forEach(function(item) {
                            ...
                            if (!groupedItems[key]) {
                                ...
                                groupedItems[key]['cart_quantity'] = parseInt(item['cart_quantity'] || 1);
                            } else {
                        ...
                        for (var key in groupedItems) {
                            if (groupedItems.hasOwnProperty(key)) {
                                ...
                                var toppingText = (item['topping'] && item['topping'].length > 0)
                                    ? 'Topping: ' + item['topping'].map(function(t) { return t.name; }).join(', ')
                                    : 'Không có topping';

                                // Tính tổng giá topping (nếu có)
                                var toppingTotalPrice = (item['topping'] && item['topping'].length > 0)
                                ...
                                var totalPrice = (basePrice + toppingTotalPrice + extraPrice) * quantity;
                    ...
                    $('.button_del').click(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(dataDel) {
                                $('.tr-' + id).remove();
                                $('.total__price').text(formatter.format(dataDel[0]) + ' VNĐ');
                            },
                            error: function(xhr) {
