...
-- Dumping structure for table datn.categorys
...
-- Dumping data for table datn.categorys: ~6 rows (approximately)
INSERT INTO `categorys` (`category_id`, `category_name`, `category_keyword`, `category_description`, `created_at`, `updated_at`) VALUES
	(1, 'Trà Sữa', 'tra-sua', 'Hương vị trà sữa đậm đà, kết hợp hoàn hảo giữa trà và sữa.', '2026-01-22 11:17:44', '2026-01-22 11:17:44'),
	(2, 'Trà Trái Cây', 'tra-trai-cay', 'Tươi mát, giải nhiệt với các loại trái cây nhiệt đới.', '2026-01-22 11:17:44', '2026-01-22 11:17:44'),
	(3, 'Macchiato', 'macchiato', 'Lớp kem cheese béo ngậy phủ trên nền trà thơm.', '2026-01-22 11:17:44', '2026-01-22 11:17:44'),
	(4, 'Sữa Chua', 'sua-chua', 'Sữa chua dẻo mịn kết hợp topping đa dạng.', '2026-01-22 11:17:44', '2026-01-22 11:17:44'),
	(5, 'Cà Phê', 'ca-phe', 'Đậm đà hương vị cà phê Việt Nam và Ý.', '2026-01-22 11:17:44', '2026-01-22 11:17:44'),
	(6, 'Đá Xay', 'da-xay', 'Mát lạnh sảng khoái với các món đá xay.', '2026-01-22 11:17:44', '2026-01-22 11:17:44');

-- Dumping structure for table datn.citys
...
-- Dumping data for table datn.citys: ~63 rows (approximately)
...
-- Dumping structure for table datn.coupons
...
-- Dumping data for table datn.coupons: ~0 rows (approximately)

-- Dumping structure for table datn.districts
CREATE TABLE IF NOT EXISTS `districts` (
  ...
  CONSTRAINT `districts_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `citys` (`city_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table datn.districts: ~713 rows (approximately)
...
-- Dumping data for table datn.images: ~2 rows (approximately)
...
-- Dumping structure for table datn.migrations
...
-- Dumping data for table datn.migrations: ~14 rows (approximately)
...
-- Dumping structure for table datn.orderdetail
CREATE TABLE IF NOT EXISTS `orderdetail` (
  ...
  CONSTRAINT `orderdetail_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `orderdetail_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table datn.orderdetail: ~11 rows (approximately)
...
-- Dumping structure for table datn.orderdetail_topping
CREATE TABLE IF NOT EXISTS `orderdetail_topping` (
  ...
  KEY `orderdetail_topping_topping_id_foreign` (`topping_id`),
  CONSTRAINT `orderdetail_topping_order_detail_id_foreign` FOREIGN KEY (`order_detail_id`) REFERENCES `orderdetail` (`order_detail_id`) ON DELETE CASCADE,
  CONSTRAINT `orderdetail_topping_topping_id_foreign` FOREIGN KEY (`topping_id`) REFERENCES `toppings` (`topping_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table datn.orderdetail_topping: ~16 rows (approximately)
...
-- Dumping data for table datn.orders: ~6 rows (approximately)
...
-- Dumping structure for table datn.posts
...
-- Dumping data for table datn.posts: ~4 rows (approximately)
...
-- Dumping data for table datn.products: ~26 rows (approximately)
...
-- Dumping structure for table datn.slide
...
-- Dumping data for table datn.slide: ~0 rows (approximately)

-- Dumping structure for table datn.toppings
CREATE TABLE IF NOT EXISTS `toppings` (
  `topping_id` int unsigned NOT NULL AUTO_INCREMENT,
  `topping_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table datn.toppings: ~3 rows (approximately)
...
-- Dumping data for table datn.users: ~12 rows (approximately)
...
-- Dumping structure for table datn.wishlist
...
-- Dumping data for table datn.wishlist: ~0 rows (approximately)
